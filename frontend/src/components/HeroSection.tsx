  ...
  return (
    <section className="bg-black text-white border-b-[3px] border-[#b8962e] overflow-hidden">
      <div className="max-w-[1080px] mx-auto flex flex-col sm:flex-row min-h-[auto] sm:min-h-[520px]">
        ...
        {/* Text */}
        <div className="flex-1 flex flex-col justify-center py-10 sm:py-[72px] px-5 sm:px-12 text-right border-r-0 sm:border-r border-white/[0.07]">
          ...
          <div className="w-11 h-0.5 bg-[#b8962e] mb-4 mr-0 ml-auto" />
          <ul className="list-none mb-6 sm:mb-8 space-y-0">
            {[t.cred1, t.cred2, t.cred3].map((c, i) => (
              <li key={i} className="text-[13px] sm:text-[14px] text-white/62 py-2 border-b border-white/[0.07] flex items-center gap-2.5 justify-end">
                <span>{c}</span>
          ...
          <div className="flex justify-end">
            <a
              ...
              className="inline-flex items-center gap-2 bg-white text-black text-[12px] sm:text-[13px] font-bold px-5 sm:px-6 py-[11px] sm:py-[13px] tracking-[0.06em] uppercase hover:bg-[#f5eedc] transition-colors"
            >
